...
('organisasi', 'PASKIBRAKA', 'ketua', NULL, 5, 'Ketua PASKIBRAKA'),
('organisasi', 'PASKIBRAKA', 'wakil ketua', NULL, 4, 'Wakil ketua PASKIBRAKA'),
('organisasi', 'PASKIBRAKA', 'sekretaris', NULL, 4, 'Sekretaris PASKIBRAKA'),
('organisasi', 'PASKIBRAKA', 'bendahara', NULL, 3, 'Bendahara PASKIBRAKA'),
('organisasi', 'PASKIBRAKA', 'koordinator', NULL, 2, 'Koordinator PASKIBRAKA'),
('organisasi', 'PASKIBRAKA', 'anggota', NULL, 1, 'Anggota PASKIBRAKA'),
-- EVENT
